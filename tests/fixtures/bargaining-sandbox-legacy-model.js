// Retired 100 by 100 model, retained only for formula/mesh regression tests.
// See docs/history/bargaining-sandbox-before-promotion.md.
(function (global) {
  "use strict";
  ...
  function checkBuyerDsicPayment(actual, envelope) {
    return sharedEnvelope.checkDsicPaymentOffsets(
  ...
  global.LegacyBargainingSandboxModel = Object.freeze({
